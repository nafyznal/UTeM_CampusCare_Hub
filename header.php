<header style="width:100%">
    <div id="header-container">
        ...
        <h1 style="color: #541A1A; margin: 0;">Admin Dashboard</h1>
        
        <div class="icon">
            <a href="home.html" id="home-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#541A1A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="24" height="24">
