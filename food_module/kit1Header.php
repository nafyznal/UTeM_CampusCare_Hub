            ...
            <ul class="sub-menu dropdown-closed" id="aidSubMenu">
                <li>
                    ...
                    <ul class="sub-sub-menu dropdown-closed" id="foodSubMenu">
                        <li><a href="kit1.php">Kit</a></li>
                        <li><a href="meal1.php">Meal</a></li>
                    </ul>
                </li>

                <li><a href="essential1.php">Essential</a></li>
            </ul>
        </li>

        <!-- History dengan popup -->
        <li>
            <a href="#" onclick="showErrorPopup()" class="menu-link has-hover-icon" style="display:flex;align-items:center;gap:14px;">
...
<!-- Popup Error -->
<div id="popup" class="popup" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);justify-content:center;align-items:center;z-index:9999;">
  <div class="popup-content" style="background:white;color:black;padding:20px;border-radius:10px;text-align:center;position:relative;">
    <img src="images/error.png" class="medium" alt="Status" style="width:50px;height:50px;">
    <h3 id="popupMessage">You should register first before go to next</h3>
    <button onclick="closePopup()" style="margin-top:15px;padding:8px 15px;border:none;border-radius:6px;background:#541A1A;color:white;cursor:pointer;">Close</button>
  </div>
</div>
